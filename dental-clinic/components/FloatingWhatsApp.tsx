  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl p-4 max-w-[200px] border border-slate-100"
          >
      ...
      <motion.a
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl shadow-green-500/40"
      >
        {/* Pulse rings */}
